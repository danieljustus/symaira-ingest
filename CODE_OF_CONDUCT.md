...
reported via [GitHub's private vulnerability reporting](https://github.com/danieljustus/symaira-ingest/security/advisories/new),
the same private channel used for security reports in
[SECURITY.md](.github/SECURITY.md). All complaints will be reviewed and
